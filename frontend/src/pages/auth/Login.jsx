  ...
  return (
    <div className="flex h-screen overflow-hidden font-sans">
      ...
      >
        ...
        <div
          ref={badgeRef}
          className="flex items-center gap-2 bg-white/15 border border-white/25 rounded-full px-4 py-1.5 w-fit mb-8 text-sm font-medium backdrop-blur-sm"
        >
        ...
        >
          Pick up right where you left off — reminders, insights, and your care
          team are waiting.
        </p>
          ...
          {[
            {
              ...
              value: "12d",
              label: "Active streak · of perfect adherence",
            },
            {
              icon: <FaHeartbeat className="text-white text-lg" />,
              value: "87",
              label: "Wellness score · +4 this week",
            },
          ].map((stat, i) => (
            <div
              key={i}
